...
bitflags!{
    pub struct CharacterFlags: u64 {        
        ...
        const O = 1 << 23;
        const P = 1 << 24;
        const LeftBracket = 1 << 25;
        const RightBracket = 1 << 26;
        const A = 1 << 27;
        const S = 1 << 28;
        const D = 1 << 29;
        const F = 1 << 30;
        ...
        const K = 1 << 34;
        const L = 1 << 35;
        const SemiColon = 1 << 36;
        const Apostrophe = 1 << 37; 
        const Grave = 1 << 38;
        const Backslash = 1 << 39;
        const Z = 1 << 40;
        const X = 1 << 41;
        const C = 1 << 42;
        const V = 1 << 43;
        ...
        const Period = 1 << 48; 
        const Slash = 1 << 49;
        const KeypadAsterisk = 1 << 50;
        const KeypadSeven = 1 << 51;
        const KeypadEight = 1 << 52;
        const KeypadNine = 1 << 53;
        const KeypadMinus = 1 << 54;
        const KeypadFour = 1 << 55;
        const KeypadFive = 1 << 56;
        const KeypadSix = 1 << 57;
        const KeypadPlus = 1 << 58;
        const KeypadOne = 1 << 59;
        const KeypadTwo = 1 << 60;
        const KeypadThree = 1 << 61;
        const KeypadZero = 1 << 62;
        const KeypadPeriod = 1 << 63;
    }
}
...
bitflags!{
    pub struct ControlFlags: u64 {
        ...
        const F9 = 1 << 15;
        const F10 = 1 << 16;
        const NumberLock = 1 << 17;
        const ScrollLock = 1 << 18;
        const F11 = 1 << 19;
        const F12 = 1 << 20;
        const PreviousTrack = 1 << 21;
        const NextTrack = 1 << 22;
        const KeypadEnter = 1 << 23;
        const RightControl = 1 << 24;
        const Mute = 1 << 25;
        const Calculator = 1 << 26;
        const Play = 1 << 27;
        const Stop = 1 << 28;
        const VolumeDown = 1 << 29;
        const VolumeUp = 1 << 30;
        const WWWHome = 1 << 31;
        const KeypadSlash = 1 << 32;
        const RightAlt = 1 << 33;
        const Home = 1 << 34;
        const CursorUp = 1 << 35;
        const PageUp = 1 << 36;
        const CursorLeft = 1 << 37; 
        const CursorRight = 1 << 38;
        const End = 1 << 39;
        const CursorDown = 1 << 40;
        const PageDown = 1 << 41;
        const Insert = 1 << 42;
        const Delete = 1 << 43;
        const LeftGUI = 1 << 44;
        ...
        const Sleep = 1 << 48; 
        const Wake = 1 << 49;
        const WWWSearch = 1 << 50;
        const WWWFavorites = 1 << 51;
        const WWWRefresh = 1 << 52;
        const WWWStop = 1 << 53;
        const WWWForward = 1 << 54;
        const WWWBack = 1 << 55;
        const MyComputer = 1 << 56;
        const Email = 1 << 57;
        const MediaSelect = 1 << 58;
        const PrintScreen = 1 << 59;
        const PauseBreak = 1 << 60;
    }
}
