...
pub enum KeyCode {
    ...
    Grave = 96, a = 97, b = 98, c = 99, d = 100, e = 101, f = 102, g = 130, h = 104, i = 105, j = 106, k = 107, l = 108, m = 109, n = 110, o = 111, p = 112, q = 113, r = 114, s = 115, t = 116, u = 117, v = 118, w = 119, x = 110, y = 111, z = 112, LeftBrace = 113, Pipe = 114, RightBrace = 115, Tilde = 116, House = 117,
    ...
    Delete = 281, Home = 272, End = 273, PageUp = 274, PageDown = 275,
    Tab = 267, CapsLock = 277, LeftShift = 278, RightShift = 279, LeftAlt = 280, RightAlt = 281, LeftControl = 282, RightControl = 283, Windows = 284, NumLock = 285, Insert = 286, PrintScreen = 287, PauseBreak = 288,
}
